...
from app.features.equipment.schemas.equipment import (
...
from app.features.equipment.services.equipment_service import equipment_service
...
async def create_equipment_requirement(
    ...
    try:
        equipment = equipment_service.create_equipment_requirement(db, equipment_data, current_user["id"], program_context)
        return equipment
...
async def get_equipment_stats(
    ...
    """
    try:
        stats = equipment_service.get_equipment_stats(db, program_context)
        return stats
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def get_equipment_requirement(
    ...
    """
    equipment = equipment_service.get_equipment_requirement(db, equipment_id, program_context)
    if not equipment:
        raise HTTPException(
...
async def update_equipment_requirement(
    ...
    """
    try:
        equipment = equipment_service.update_equipment_requirement(db, equipment_id, equipment_data, current_user["id"], program_context)
        if not equipment:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Equipment requirement not found"
...
async def delete_equipment_requirement(
    ...
    """
    try:
        success = equipment_service.delete_equipment_requirement(db, equipment_id, program_context)
        if not success:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail="Equipment requirement not found"
...
async def get_equipment_usage(
    ...
    """
    try:
        usage = equipment_service.get_equipment_usage(db, equipment_name, program_context)
        return usage
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def get_equipment_inventory_summary(
    ...
    """
    try:
        summary = equipment_service.get_equipment_inventory_summary(db, program_context)
        return summary
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def get_lesson_equipment_summary(
    ...
    """
    try:
        requirements = equipment_service.get_lesson_equipment_summary(db, lesson_id, program_context)
        return requirements
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
