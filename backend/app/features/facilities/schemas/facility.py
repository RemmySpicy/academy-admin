...
class FacilityBase(BaseModel):
    ...
    access_fee_kids: Optional[int] = Field(None, ge=0, description="Access fee for kids (in cents)")
    access_fee_adults: Optional[int] = Field(None, ge=0, description="Access fee for adults (in cents)")
