          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{mockDashboardStats.active_sponsorships}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{mockDashboardStats.students_on_waitlist}</p>
              </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      {alert.amount && (
                        <p className="text-sm text-gray-600">Amount: {formatCurrency(alert.amount)}</p>
                      )}
                      {alert.due_date && (
                        <p className="text-sm text-gray-600">Due: {new Date(alert.due_date).toLocaleDateString()}</p>
                      )}
                      {alert.percentage && (
                        <p className="text-sm text-gray-600">Budget used: {alert.percentage}%</p>
                      )}
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">{mockPartnerInfo.contact_person}</p>
                </div>
